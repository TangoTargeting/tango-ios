...
struct Media {
    ...
    static func mediaSummary(userInfo: PayloadDictionary) -> MediaSummary? {
        if let dataDictionary = userInfo[PayloadKeys.data] as? PayloadDictionary {
            if let objectDictionary = dataDictionary[PayloadKeys.object] as? PayloadDictionary {
                if let contentDictionary = objectDictionary[PayloadKeys.content] as? PayloadDictionary {
                    if let mediaDictionary = contentDictionary[PayloadKeys.media] as? PayloadDictionary {
